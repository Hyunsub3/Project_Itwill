...
(시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.
					...
					<h3><input type="checkbox" name="c1" id="c1" value="c1"><font size="3">이용약관 안내(필수)</font></h3>
					</tr>
  ...
  * 수탁업체
    ...
    - 행정자치부
      ...
      · 개인정보 보유 및 이용 기간 : 행정자치부에서는 이미 보유하고 있는 개인정보이기 때문에 별도로 저장하지 않음
					...
					<h3><input type="checkbox" name="c2" id="c2" value="c2"><font size="3">개인정보 수집 및 이용에 대한 안내(필수)</font></h3>
					</tr>
...
시네마윌에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(앱 알림 또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스(별도 회원 체계로 운영하거나 네이버 가입 이후 추가 가입하여 이용하는 서비스 등)의 경우, 개별 서비스에 대해 별도 수신 동의를 받을 수 있으며, 이때에도 수신 동의에 대해 별도로 안내하고 동의를 받습니다.



					
					</textarea>
					<h3><input type="checkbox" name="c3" id="c3" value="c3"><font size="3">프로모션 정보 수신 동의(선택)</font></h3>
					</tr>
